...
Download the latest release from [GitHub Releases](https://github.com/PteroLabsAI/PteroSim-UAV-Simulator/releases), extract, and run `PteroSim.exe`. See the [documentation]([https://pterolabs.ai](https://pterosimdocs.readthedocs.io/en/latest/)) for setup guides and API reference.
